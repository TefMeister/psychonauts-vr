...
always know where to look. You are in **psychonauts-vr-mod**.

| Repository | What lives here |
| --- | --- |
| **psychonauts-vr-mod** ← you are here | The mod itself — the DirectX 9 stereo + head-tracking VR proxy (`d3d9.dll`). |
